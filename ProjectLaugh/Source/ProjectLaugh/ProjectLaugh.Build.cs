...
public class ProjectLaugh : ModuleRules
{
	public ProjectLaugh(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore", "EnhancedInput", "UMG", "LevelSequence", "OnlineSubsystem", "OnlineSubsystemUtils", "MovieScene", "Niagara", "GameplayTags" });
